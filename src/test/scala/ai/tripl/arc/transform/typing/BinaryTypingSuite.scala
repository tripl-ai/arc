...
class BinaryTypingSuite extends FunSuite with BeforeAndAfter {
  ...
  test("BinaryTyping: value has leading spaces") {
    val col = BinaryColumn(None, name="name", description=Some("description"), nullable=true, nullReplacementValue=Some(""), trim=true, nullableValues=""::Nil, encoding=EncodingType.Base64, metadata=None)
  ...
  test("BinaryTyping: invalid hexadecimal") {
    val col = BinaryColumn(None, name="name", description=Some("description"), nullable=true, nullReplacementValue=Some(""), trim=true, nullableValues=""::Nil, encoding=EncodingType.Hexadecimal, metadata=None)
