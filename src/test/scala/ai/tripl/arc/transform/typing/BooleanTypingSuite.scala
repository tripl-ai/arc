...
class BooleanTypingSuite extends FunSuite with BeforeAndAfter {
  ...
  test("BooleanTyping: value has leading spaces") {
    val col = BooleanColumn(None, name="name", description=Some("description"), nullable=true, nullReplacementValue=Some("true"), trim=true, nullableValues=""::Nil, trueValues=List("true","true"), falseValues=List("false","false"), metadata=None)
  ...
  test("BooleanTyping: empty input WITHOUT nullReplacementValue") {
    val col = BooleanColumn(None, name="name", description=Some("description"), nullable=false, nullReplacementValue=None, trim=true, nullableValues=""::Nil, trueValues=List("true","TRUE"), falseValues=List("false","FALSE"), metadata=None)
    Typing.typeValue("", col) match {
      case (res, Some(err)) => {
        assert(res === None)
  ...
  test("BooleanTyping: allowed complex characters") {
    val col = BooleanColumn(None, name="name", description=Some("description"), nullable=false, nullReplacementValue=None, trim=true, nullableValues=""::Nil, trueValues=List("true","TRUE","ኃይሌ"), falseValues=List("false","FALSE"), metadata=None)
