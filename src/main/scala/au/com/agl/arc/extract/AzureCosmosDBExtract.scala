...
object AzureCosmosDBExtract {
  ...
  def extract(extract: AzureCosmosDBExtract)(implicit spark: SparkSession, logger: au.com.agl.arc.util.log.logger.Logger, arcContext: ARCContext): Option[DataFrame] = {
