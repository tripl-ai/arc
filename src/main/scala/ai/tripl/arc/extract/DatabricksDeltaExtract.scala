...
object DatabricksDeltaExtract {
  ...
  def extract(extract: DatabricksDeltaExtract)(implicit spark: SparkSession, logger: ai.tripl.arc.util.log.logger.Logger, arcContext: ARCContext): Option[DataFrame] = {
