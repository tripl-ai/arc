...
|inputLeftKeys|Array[String]|false|A list of columns to create the join key from the first incoming Spark dataset.|
|inputRightKeys|Array[String]|false|A list of columns to create the join key from the second incoming Spark dataset.|
